...
- [企劃發想書](link-to-your-pdf) 📄
- [記憶翻牌遊戲](link-to-your-pdf) 🎮
...
分工：爬蟲、資料處理、流程設計
- [簡報](link-to-your-pdf) 📄
- [『樂透了沒』彩券兌獎系統](link-to-your-python-file) 🐍

### [機器學習] Python實作機器學習
描述：以kaggle經典題目做實作KNN、Random Forest等機器學習分類器。

分工：獨自完成
- K-Meang手寫數字[Python](link-to-python)🐍
- K-mean-鳶尾花[Python](link-to-python)🐍
- KNN分類器-乳癌機率[Python](link-to-python)🐍
- 線性迴歸模型-波士頓房價[Python](link-to-python)🐍
- LogisticRegression-傑克蘿絲生存率[Python](link-to-python)🐍
- 決策樹分類器-傑克蘿絲生存率[Python](link-to-python)🐍
